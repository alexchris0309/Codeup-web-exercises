...
var hercule= Number(prompt('how many days renting Hercules'));
var bear= Number(prompt('how many days renting brother bear'));
...
//
 ...
 alert("you earned$" + ((googleHours * googleRate)+ (facebookHours*fbRate)+(amazonHours * amazonRate)).toFixed(2));
//
//
//
